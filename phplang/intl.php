...
/**
 * Intl ICU based number formatter.
 *
 * Programs store and operate on numbers using a locale-independent binary representation. When displaying or printing a
 * number it is converted to a locale-specific string. For example, the number <code>12345.67</code> is
 * <code>"12,345.67"</code> in the US, <code>"12 345,67"</code> in France and <code>"12.345,67"</code> in Germany.
 *
 * By invoking the methods provided by the {@see \NumberFormatter} class, you can format numbers, currencies, and
 * percentages according to the specified or default locale. {@see \NumberFormatter} is locale-sensitive so you need to
 * create a new {@see \NumberFormatter} for each locale. {@see \NumberFormatter} methods format primitive-type numbers,
 * such as double and output the number as a locale-specific string.
 *
 * For currencies you can use currency format type to create a formatter that returns a string with the formatted number
 * and the appropriate currency sign. Of course, the {@see \NumberFormatter} class is unaware of exchange rates so, the
 * number output is the same regardless of the specified currency. This means that the same number has different
 * monetary values depending on the currency locale. If the number is <code>9988776.65</code> the results will be:
 *
 * <ul>
 *   <li><code>"9 988 776,65 �"</code> in France</li>
 *   <li><code>"9.988.776,65 �"</code> in Germany</li>
 *   <li><code>"$9,988,776.65"</code> in the United States</li>
 * </ul>
 *
 * In order to format percentages, create a locale-specific formatter with percentage format type. With this formatter,
 * a decimal fraction such as <code>0.75</code> is displayed as <code>"75%"</code>.
 *
...
/**
 * Date Formatter is a concrete class that enables locale-dependent formatting/parsing of dates using pattern strings
 * and/or canned patterns.
 *
 * This class represents the ICU date formatting functionality. It allows users to display dates in a localized format
 * or to parse strings into PHP date values using pattern strings and/or canned patterns.
 *
 * @link http://php.net/class.intldateformatter.php
 * @since 5.3.0
 */
...
/**
 * This class is used for generating exceptions when errors occur inside intl functions. Such exceptions are only
 * generated when {@link http://php.net/manual/intl.configuration.php#ini.intl.use-exceptions <code>intl.use_exceptions</code>}
 * is enabled.
 *
 * @since 5.5.0
 */
...
class Transliterator  {
   ...
   * @link http://php.net/transliterator.construct.php
   */
...
/**
 * @link http://php.net/class.spoofchecker.php
 */
class Spoofchecker  {
 ...
 * boolean <b>FALSE</b>.
 */
function collator_get_locale ($type = null) {}
 ...
 * @link http://php.net/function.locale-get-default.php
 ...
 * @link http://php.net/function.locale-set-default.php
 * @param string $name <p>
 ...
 * @link http://php.net/function.grapheme-stripos.php
 * @param string $haystack <p>
 * The string to look in. Must be valid UTF-8.
 * </p>
 * @param string $needle <p>
 ...
 * @link http://php.net/function.grapheme-strrpos.php
 * @param string $haystack <p>
 * The string to look in. Must be valid UTF-8.
 * </p>
 * @param string $needle <p>
 ...
 * @link http://php.net/function.grapheme-strripos.php
 * @param string $haystack <p>
 * The string to look in. Must be valid UTF-8.
 * </p>
 * @param string $needle <p>
 ...
 * @link http://php.net/function.grapheme-strstr.php
 * @param string $haystack <p>
 * The input string. Must be valid UTF-8.
 * </p>
 * @param string $needle <p>
 ...
 * @link http://php.net/function.grapheme-stristr.php
 * @param string $haystack <p>
 * The input string. Must be valid UTF-8.
 * </p>
 * @param string $needle <p>
 ...
 * @link http://php.net/function.grapheme-extract.php
 * @param string $haystack <p>
 * String to search.
 * </p>
 * @param int $size <p>
 ...
 * @link http://php.net/function.idn-to-ascii.php
 ...
 * @link http://php.net/function.idn-to-utf8.php
 ...
 * @link http://php.net/function.intl-get-error-code.php
 ...
 * @link http://php.net/function.intl-get-error-message.php
 ...
 * @link http://php.net/function.intl-is-failure.php
 ...
 * @link http://php.net/function.intl-error-name.php
 * @param int $error_code <p>
 * ICU error code.
 * </p>
 ...
 * @link http://php.net/intl.constants.php
 */
