...
define ('PGSQL_LIBPQ_VERSION', "9.3.1");
define ('PGSQL_LIBPQ_VERSION_STR', "PostgreSQL 9.3.1 on x86_64-apple-darwin13.0.0, compiled by Apple LLVM version 5.0 (clang-500.2.79) (based on LLVM 3.3svn), 64-bit");
